...
class SJG_CreateControls(object):
    ...
    def makeCurves():
        ...
        cmds.setAttr('grp_cc_l_shoulder.rotateY', 90)
        cmds.parent('grp_cc_l_shoulder', 'grp_cc_l_clavicle')

        makeCircle('l_elbow')
        cmds.parentConstraint('rig_l_shoulder01|rig_l_elbow01', 'grp_cc_l_elbow')
        cmds.delete('grp_cc_l_elbow_parentConstraint1')
        cmds.setAttr('grp_cc_l_elbow.rotateY', 90)
        ...
        cmds.setAttr('grp_cc_l_wrist.rotateY', 90)
        ...
        cmds.setAttr('grp_cc_l_arm.rotateY', 90)
        cmds.parentConstraint('grp_cc_l_clavicle', 'grp_cc_l_arm')
        cmds.parent('grp_cc_l_arm', 'controlCurves')

        #A group to make the fingers follow the wrist while giving a level of separation
        cmds.group(em=True, name='grp_l_fingers')
        cmds.parentConstraint('rig_l_wrist01', 'grp_l_fingers')
        cmds.parent('grp_l_fingers', 'controlCurves')

        makeCircle('l_index01')
        cmds.parentConstraint('rig_l_index01', 'grp_cc_l_index01')
        cmds.delete('grp_cc_l_index01_parentConstraint1')
        cmds.setAttr('grp_cc_l_index01.rotateY', 90)
        ...
        cmds.setAttr('grp_cc_l_index02.rotateY', 90)
        ...
        cmds.setAttr('grp_cc_l_index03.rotateY', 90)
        ...
        cmds.setAttr('grp_cc_l_middle01.rotateY', 90)
        ...
        cmds.setAttr('grp_cc_l_middle02.rotateY', 90)
        ...
        cmds.setAttr('grp_cc_l_middle03.rotateY', 90)
        ...
        cmds.setAttr('grp_cc_l_ring01.rotateY', 90)
        ...
        cmds.setAttr('grp_cc_l_ring02.rotateY', 90)
        ...
        cmds.setAttr('grp_cc_l_ring03.rotateY', 90)
        ...
        cmds.setAttr('grp_cc_l_pinky01.rotateY', 90)
        ...
        cmds.setAttr('grp_cc_l_pinky02.rotateY', 90)
        ...
        cmds.setAttr('grp_cc_l_pinky03.rotateY', 90)
        cmds.parent('grp_cc_l_pinky03', 'cc_l_pinky02')
        
        makeCircle('l_thumb01')
        cmds.parentConstraint('rig_l_thumb01', 'grp_cc_l_thumb01')
        cmds.delete('grp_cc_l_thumb01_parentConstraint1')
        cmds.setAttr('grp_cc_l_thumb01.rotateY', 90)
        cmds.setAttr('grp_cc_l_thumb01.rotateZ', -60)
        cmds.parent('grp_cc_l_thumb01', 'grp_l_fingers')

        makeCircle('l_thumb02')
        cmds.parentConstraint('rig_l_thumb02', 'grp_cc_l_thumb02')
        cmds.delete('grp_cc_l_thumb02_parentConstraint1')
        cmds.setAttr('grp_cc_l_thumb02.rotateY', 90)
        cmds.setAttr('grp_cc_l_thumb02.rotateX', 60)
        cmds.parent('grp_cc_l_thumb02', 'cc_l_thumb01')

        makeCircle('l_thumb03')
        cmds.parentConstraint('rig_l_thumb03', 'grp_cc_l_thumb03')
        cmds.delete('grp_cc_l_thumb03_parentConstraint1')
        cmds.setAttr('grp_cc_l_thumb03.rotateY', 90)
        cmds.setAttr('grp_cc_l_thumb03.rotateX', 60)
        cmds.parent('grp_cc_l_thumb03', 'cc_l_thumb02')
